            ...
            <div class="max-w[90rem] u-justify-center u-disp-flex u-mar-mxa u-mar-b45">
                <h1 class="u-disp-flex">
                    <picture class="u-posi-rela u-disp-flex u-justify-center">
                        ...
                        <img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/page_mv1.png" class="u-w_tabmv u-h_maxpc u-mar-mt0tab" alt="">
                    ...
                    <p class="u-posi-abso c-title_mv"><span>みつわについて</span><br><br>高齢者社会を考え活動する</p>
                </h1>
            </div>
