        ...
        <div class="inner u-w_maxpc u-mar-mxa">
            ...
            <h1 class="u-disp-flex">
                    ...
                    <picture class="u-posi-rela u-disp-flex u-justify-center">
                        ...
                        <p class="u-posi-abso c-title_mv">利用者様<br><span>アルバム</span></p>
            ...
            <!--トップへ戻る追従ボタン-->
            <a class="c-btn-pagetop u-disp-block" href="/album/#head">
                    ...
                    if($wp_query->have_posts()):
                        ...
                        foreach ($mojilist as $index=>$value):
                            ...
                            if($pos !== false):
                                if($i == 0){
                                    //最初のみ
                                    echo  '<h2 class="c-title_post c-bk_title1" id="' . $mojilabel[$index] . '">'. $mojilabel[$index] .'</h2><ul>';
                                    $num = $index;
                                    $i = $i + 1;
                                }else{
                                    if($num != $index){
                                        echo  '</ul><h2 class="c-title_post c-bk_title1" id="' . $mojilabel[$index] . '">'. $mojilabel[$index] .'</h2><ul>';
                                        $num = $index;
                                    }
                                }
                        ?>
